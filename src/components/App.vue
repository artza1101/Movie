...
<script>
  ...
  const config = {
    apiKey: 'IzaSyB-m9srs748X6ZpZyszv0KfKuvaNSf-2PE',
    authDomain: 'ase-f994d.firebaseapp.com',
    databaseURL: 'ttps://base-f994d.firebaseio.com',
    projectId: 'ase-f994d',
    storageBucket: 'ase-f994d.appspot.com',
    messagingSenderId: '36623167018'
  }
